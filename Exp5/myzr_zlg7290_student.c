/*
 * BUAA LDMC
 * Online Platform: 219.224.160.135:84
 */
...
unsigned char hex_map[16] = {
	...
	0x66, 0xb6, 0xbe, 0xe0,
	0xfe, 0xf6, 0xee, 0x3e,
	0x9c, 0x7a, 0x9e, 0x8e    // 补全
};

unsigned char code_map[28] = {
    0xee, 0x3e, 0x9c, 0x7a, 
	0x9e, 0x8e, 0xbc, 0x6e, 
	0xf0, 0xe0, 0xae, 0x1c, 
	0xec, 0x2a, 0x3a, 0xce, 
...
static int __init zz_init(void)
{
    ...
    write_val[0] = 0x10;
    write_val[1] = code_map[25];
    zlg7290_hw_write(ptr_zlg7290, 2, &len, write_val);
    zlg7290_hw_read(ptr_zlg7290, 1, &len, write_val);
    for (i = 0; i < 26; i++){
        if(write_val[0] == code_map[i]){
            result = 'A' + i;
            break;
        }
    }
